...
2. V tomto adresáři spusťte:
  git config --global user.email "kristianzradicka@gmail.com"
  git config --global user.name "kzradicka"
   ...
   git branch -M main
   git remote add origin https://github.com/kzradicka/dochazka-crm.git
...
AC9912f04db7b5197b3c7bdcfafdefb007

0184a1a4b16d25ccf77c2226a0924bab
